...
CREATE FUNCTION client_new (client_id u64, ip bytea, browser_name character varying, browser_ver u32, os_name character varying, os_ver u32, device_vendor character varying, device_model character varying)
  RETURNS void
  LANGUAGE plpgsql
  AS $$
DECLARE
...
CREATE TABLE user_log (
  id u64 NOT NULL, oid u64 NOT NULL, action u16 NOT NULL, uid u64 NOT NULL, val bytea DEFAULT '\x' ::bytea NOT NULL, ctime u64 DEFAULT date_part('epoch'::text, now()) NOT NULL, client_id u64 NOT NULL
);
