...
<<<<<<< HEAD
CREATE SCHEMA IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS public;
...
<<<<<<< HEAD
CREATE INDEX IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS "user_log.uid.oid.action.ctime" ON user_log USING btree (uid, oid, action, ctime DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS IF NOT EXISTS "user_log.uid.oid.ctime" ON user_log USING btree (uid, oid, ctime DESC);
=======
